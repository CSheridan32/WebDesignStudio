...
/**
 * Capture the actual React app HTML and create a static version
 */

async function captureBuild() {
  console.log('🚀 Capturing your React website...');
  ...
  try {
    ...
    // Get the actual HTML from the running dev server
    console.log('Fetching your website from development server...');
    
    const { stdout } = await execAsync('curl -s http://localhost:5000/', { timeout: 10000 });
    
    if (!stdout || stdout.includes('Cannot GET')) {
      throw new Error('Could not fetch website from dev server');
    }
    
    console.log('✅ Captured website HTML');
    
    // Read your actual CSS file to get the real styling
    const cssContent = await fs.readFile('client/src/index.css', 'utf8');
    
    // Create the complete HTML with embedded styles
...
<head>
  ...
  <style>
    ...
    /* Additional inline styles for static deployment */
    .lucide { width: 1em; height: 1em; stroke: currentColor; stroke-width: 2; }
...
<body class="min-h-screen bg-background font-sans antialiased">
  <div id="root">
      ...
      <div class="container relative z-10 mx-auto px-4">
        <div class="mx-auto max-w-4xl text-center">
          ...
          <p class="mb-8 text-xl text-primary-foreground/90 lg:text-2xl">
            Beautiful, accessible websites for cafés, salons, tradespeople, and growing businesses
          </p>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div class="group rounded-lg border bg-card p-6 text-card-foreground shadow-sm transition-shadow hover:shadow-lg">
            ...
            <h3 class="mb-2 text-lg font-semibold">Cafés & Restaurants</h3>
    ...
    <!-- Values Section -->
    <section class="bg-secondary/5 py-20">
      <div class="container mx-auto px-4">
        <div class="mx-auto max-w-2xl text-center">
        ...
        <div class="mt-16 grid gap-8 lg:grid-cols-3">
          <div class="group rounded-lg border bg-card p-8 text-card-foreground shadow-sm transition-shadow hover:shadow-lg">
            ...
            <ul class="space-y-2 text-sm text-muted-foreground">
              <li class="flex items-center">✓ Brand-focused design</li>
              <li class="flex items-center">✓ Mobile-first approach</li>
              <li class="flex items-center">✓ Fast loading speeds</li>
            </ul>
          </div>
          <div class="group rounded-lg border bg-card p-8 text-card-foreground shadow-sm transition-shadow hover:shadow-lg">
            <div class="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
            ...
            <ul class="space-y-2 text-sm text-muted-foreground">
              <li class="flex items-center">✓ Secure payment processing</li>
              <li class="flex items-center">✓ Inventory management</li>
              <li class="flex items-center">✓ Customer accounts</li>
            </ul>
          </div>
          <div class="group rounded-lg border bg-card p-8 text-card-foreground shadow-sm transition-shadow hover:shadow-lg">
            <div class="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
            ...
            <ul class="space-y-2 text-sm text-muted-foreground">
              <li class="flex items-center">✓ Search engine optimization</li>
              <li class="flex items-center">✓ Performance optimization</li>
              <li class="flex items-center">✓ Analytics setup</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <!-- Contact Section -->
    <section id="contact" class="bg-secondary/5 py-20">
      <div class="container mx-auto px-4">
        <div class="mx-auto max-w-2xl text-center">
        ...
        <div class="mx-auto mt-16 max-w-lg">
          <form id="contactForm" class="space-y-6">
            ...
            <div>
              ...
              <input type="text" id="business" name="business" placeholder="e.g., Café, Salon, Construction" class="mt-1 block w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
            </div>
            <div>
  ...
  <script>
    ...
    await fs.writeFile('dist/index.html', completeHtml);
    console.log('✅ Created enhanced index.html with your actual design');
    
    // Create 404 page
    const notFoundHtml = completeHtml.replace(
      '<title>Conall Sheridan - Web Design Studio</title>',
...
Sitemap: https://your-domain.com/sitemap.xml`;
    ...
    console.log('📋 Your beautiful React website design is now ready for deployment!');
